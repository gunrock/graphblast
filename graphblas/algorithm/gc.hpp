...
// Implementation of fused apply-vxm Independent Set graph coloring algorithm
float gcISfusedApply(Vector<int>*       v,
                     const Matrix<int>* A,
                     int                seed,
                     int                max_colors,
                     Descriptor*        desc) {
  ...
  do {
    ...
    applyVxm<int, int, int, int>(&m, GrB_NULL, GrB_NULL,
