...
do
  if [ "$TEST" = "0" ] ; then
    echo bin/gcc --timing 0 --directed=2 --debug=1 --niter=0 $DATA/$file/$file.mtx
    bin/gcc --timing 0 --directed=2 --debug=1 --niter=0 $DATA/$file/$file.mtx
  fi
done
...
do
  if [ "$TEST" = "1" ] ; then
    echo bin/gcc --timing 0 --directed=2 --debug=1 --niter=0 $DATA2/$file.mtx
    bin/gcc --timing 0 --directed=2 --debug=1 --niter=0 $DATA2/$file.mtx
  fi
done
...
do
  if [ "$TEST" = "2" ] ; then
    echo bin/gcc --timing 0 --directed=2 --debug=1 --niter=0 data/small/$file.mtx
    bin/gcc --timing 0 --directed=2 --debug=1 --niter=0 data/small/$file.mtx
  fi
done
